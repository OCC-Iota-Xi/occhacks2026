  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-center justify-center gap-3 py-5 text-center transition-colors hover:text-ring focus-visible:outline-none [&[data-state=open]>svg]:rotate-180",
          className
        )}
        {...props}
      >
